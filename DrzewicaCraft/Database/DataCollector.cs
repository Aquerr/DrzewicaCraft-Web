...
namespace DrzewicaCraft.Database
{
    public class DataCollector
    {
        ...
        {
            new Photo() { Id = 1, Name = "Szkoła podstawowa", Likes = 4, ImagePath = "~/Content/banner.jpg"},
            new Photo() { Id = 2, Name = "Blok 1", Likes = 10, ImagePath = "~/Content/Blok1.jpg"},
